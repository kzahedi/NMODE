...
DataNode::DataNode(DataXsdNode *parent)
  : DataXsdNode(parent)
{ }
...
void DataNode::add(DataParseElement *element)
{
...
void DataNode::createXsd(XsdSpecification *spec)
{
...
P3D DataNode::position()
{
  return _position;
}

string DataNode::transferfunction()
{
