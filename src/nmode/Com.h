#ifndef __COM_COMMUNICATION_H__
#define __COM_COMMUNICATION_H__
...
class ComBuffer : public std::vector<char>
{
  public:
    char label;
    // d = double
...
/** \brief TCP/IP Com communication.
 *
...
class Com
{
  public:
     ...
     *
     * Packing and unpacking of the data is done by the Com-class, in the
     * following way:
     *
     * \verbatim
     <type char>
     ...
     */
    const Com& operator<<(const std::string&) const;
     ...
     */
    const Com& operator>>(std::string&) const;
     ...
     */
    const Com& operator<<(const double&) const;
     ...
     */
    const Com& operator>>(double&) const;
     ...
     */
    const Com& operator<<(const int&) const;
     ...
     */
    const Com& operator<<(const std::vector<int>&) const;
     ...
     */
    const Com& operator>>(std::vector<int>&) const;
     ...
     */
    const Com& operator<<(const std::vector<double>&) const;
     ...
     */
    const Com& operator>>(std::vector<double>&) const;
  ...
  private:
    const Com& operator<<(const ComBuffer&) const;
    const Com& operator>>(ComBuffer&) const;

    void __check(const char a, const char b);
    void __readDouble(double *d, ComBuffer b, int startIndex);
    void __readInteger(int *i, ComBuffer b, int startIndex);
    void __writeDouble(ComBuffer *b, double d);
    void __writeInteger(ComBuffer *b, int i);
